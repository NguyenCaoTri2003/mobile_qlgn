  ...
  return (
    <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
      ...
      >
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.userInfoContainer}>
            ...
            <View style={styles.emailContainer}>
              <EvilIcons name="envelope" size={14} color="#94a3b8" />
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.iconContainer, { backgroundColor: "#e0e7ff" }]}>
                <EvilIcons name="user" size={20} color="#4f46e5" />
              </View>
            ...
            <EvilIcons name="chevron-right" size={24} color="#cbd5e1" />
          </TouchableOpacity>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.iconContainer, { backgroundColor: "#f3e8ff" }]}>
                <EvilIcons name="lock" size={20} color="#9333ea" />
              </View>
              <View style={styles.menuItemContent}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.iconContainer, { backgroundColor: "#fef3c7" }]}>
                <EvilIcons name="question" size={20} color="#d97706" />
              </View>
              <View style={styles.menuItemContent}>
        ...
        {/* VERSION INFO */}
        <Text style={styles.versionText}>Phiên bản 2.0.4</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
